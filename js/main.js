$(function() {
   ...
   ========================================================================== */
    ...
    $('.countdown').downCount({
        date: '12/15/2022 12:00:00' // m/d/y
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.result != "success") {
                    ...
                    var message = data.msg.substring(4);
                    $('#mc-notification').hide().html('<span class="success"><i class="fa fa-paper-plane"></i>' + 'Awesome! Subscription confirmed.' + '</span>').fadeIn("slow");
